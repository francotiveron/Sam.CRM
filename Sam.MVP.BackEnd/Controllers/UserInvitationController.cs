...
namespace Sam.Api
{
    ...
    {
        private readonly IUserInvitationService _service;
        private readonly IContextService _contextService;
        private readonly ILogger<UserInvitationController> _log;

        public UserInvitationController(IUserInvitationService service, IContextService contextService, ILogger<UserInvitationController> log)
        {
            _service = service;
        ...
        public async Task<IActionResult> Add([FromBody] UserInvitationModel model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody]UserInvitationModel model)
        {
            try
            {
