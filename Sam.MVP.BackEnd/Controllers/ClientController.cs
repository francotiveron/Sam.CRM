...
namespace Sam.Api
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        private readonly ILogger<ClientController> _log;


        public ClientController(IClientService service, IContextService contextService, 
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] ClientModel model)
        {
            try
            {
