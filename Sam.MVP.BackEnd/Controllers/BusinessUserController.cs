...
namespace Sam.Api.Controllers
{
    ...
    public class BusinessUserController : ControllerBase
    {
        ...
        private readonly ILogger<BusinessUserController> _log;

        public BusinessUserController(IBusinessUserService service, IContextService contextService, ILogger<BusinessUserController> log)
        {
            _service = service;
        ...
        public async Task<IActionResult> Add([FromBody] BusinessUserModel model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] BusinessUserModel model)
        {
            try
            {
