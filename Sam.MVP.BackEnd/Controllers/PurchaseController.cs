...
namespace Sam.Api
{
    ...
    public class PurchaseController : ControllerBase
    {
        ...
        public PurchaseController(IPurchaseService service, IContextService contextService, ILogger<PurchaseController> log)
        {
            _service = service;
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] PurchaseModel model)
        {
            try
            {
