...
namespace Sam.Api
{
    ...
    public class DocumentController : ControllerBase
    {
        ...
        public DocumentController(IDocumentService service, IContextService contextService, ILogger<DocumentController> log)
        {
            _service = service;
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] DocumentModel model)
        {
            try
            {
