...
namespace Sam.Api
{
    ...
    public class ClientUserController : ControllerBase
    {
        ...
        private readonly ILogger<ClientUserController> _log;

        public ClientUserController(IClientUserService service, IContextService contextService, ILogger<ClientUserController> log)
        {
            _service = service;
        ...
        public async Task<IActionResult> Add([FromBody] ClientUserModel model)
        {
            try
            {
