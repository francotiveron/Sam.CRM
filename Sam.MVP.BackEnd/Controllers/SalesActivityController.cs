...
namespace Sam.Api
{
    ...
    {
        private readonly ISalesActivityService _service;
        private readonly IContextService _contextService;
        private readonly ILogger<SalesActivityController> _log;

        public SalesActivityController(ISalesActivityService service, IContextService contextService, ILogger<SalesActivityController> log)
        {
            _service = service;
        ...
        public async Task<IActionResult> Add([FromBody] SalesActivityModel model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] SalesActivityModel model)
        {
            try
            {
