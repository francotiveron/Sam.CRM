...
namespace Sam.Api
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(IOrderService service, IContextService contextService, ILogger<OrderController> log)
        {
            _service = service;
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] OrderModel model)
        {
            try
            {
