...
namespace Sam.Api
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(IProductService service, IContextService contextService, ILogger<ProductController> log)
        {
            _service = service;
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute]Guid id, [FromBody] ProductModel model)
        {
            try
            {
